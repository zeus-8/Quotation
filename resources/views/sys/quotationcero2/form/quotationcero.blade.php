...
{!! Form::open(['route'=>'quotationC.store', 'method'=>'POST','name'=>'formulario2']) !!}   
         ...
         <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    ...
                    hoteles</a>
                        <input type="text" readonly id="txtValor"  name="hoteles" value="0" div style="border:none;background-color:transparent;" />             
            ...
            <div class="panel-body">
                <div style=margin-left:2%;>
                        ...
                        @endif
                        @if(isset($_POST['hotel']))
                            <input type='hidden' name='hote' value=''  onchange="enviar2(this.value)"/>
                        @endif
  <!--Aqui es donde trabajaras -->     
                        ...
                        <input type="hidden" name="hotel[]" value="{{$s->ho_name}}" />
                            <div class="well">
                                <h4><b>{{$s->ho_name}}</b></h4>
                              ...
                              <?php /* $con+=1; */?> 
                                @foreach ($hotels2 as $ho2 )
                                    @if($s->ho_name==$ho2->ho_name)
                                            ...
                                            <input type="checkbox" id="h{{ $hhh+=1 }}" name='opcion[]' value="{{  $ho2->cost }}"  onclick="calcular(this.checked, this.value);" />                          
                                            {{  $ho2->room }} / <b> Precio </b>: {{  $ho2->cost }}                         
                                            <input type="text" id="r{{ $hhhh+=1 }}" placeholder="Cnt.Habitaciones.." div style=Width:100px;margin:1px;  value="0" onkeyup="calcular()"/>
                                            <input type="text"  readonly   id="hab{{ $hh+=1 }}"   name="tranfers" value="0" div style="border:none;background-color:transparent;" /> 
                                ...
                                <input type="number" id="n{{ $h+=1 }}" class="form-control" div style=width:20%; name="noches[]" value="0" placeholder="cant.. noches"  onkeyup="calcular()" /> 
                                <input type="hidden"  readonly   id="ni{{ $hhhhh+=1 }}"   name="tranfers" value="0" div style="border:none;background-color:transparent;" onkeyup="calcular()" /> 
 ...
 <!--Hasta aqui alli es donde esta todo  el archivo  que conecta esta esta en la ruta public/js/ajax.js -->                                
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="well">
                                    <LABEL>
                                         <input type="hidden"  readonly   id="nii"   name="tranfers" value="0" div style="border:none;background-color:transparent;"/>                                   
                                         <input type="hidden"  readonly   id="niii"   name="tranfers" value="0" div style="border:none;background-color:transparent;"/>                                   
                                         <input type="text"  readonly   id="sumaho"   name="tranfers" value="0" div style="border:none;background-color:transparent;font-size:30px;"/>                                   
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h4 class="panel-title">
            ...
            Alimentacion</a>
            <input type="text"  id="totalali"  name="alimentacion" value="0"  div style="border:none;background-color:transparent;" />
                    ...
                    <div class="panel panel-default">
                              <div class="panel-heading">
                                    <h4 class="panel-title">
                                        ...
                                        Guias</a>
                                        <input type="hidden"  id="subiva"  name="" value="0"  div style="border:none;background-color:transparent;font-size:30px;" />                                     
                                        <input type="text"  id="sumaiv"  name="subiva2" value="0"  div style="border:none;background-color:transparent;" />                                     
                        ...
                        <?php $iii=0; ?> 
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" id="ch{{ $i+=1 }}"  name="guides[]" value="{{ $rf->cost }}" onclick="calculo2(this.checked, this.value);">
                                                    {{ $rf->gu_name }} 
                                                   ...
                                                   <label><input type="text"  id="i{{ $ii+=1 }}"  name="tranfers" value="0" class="form-control" div style=width:50px; onkeyup="calculo2()" />  </label>
                                                    Total:
                                                    <input type="text"  readonly   id="iv{{ $iii+=1 }}"   name="tranfers" value="0" div style="border:none;background-color:transparent;" /> 
                                                    </label>
                                                   <br>
                                                </label>
                                            </div>
                    ...
                    <!--impuestos y subtotales de los guias-->
                                        <div align="right">
                                            <div class="well" div style=width:20%;>
                                                 ...
                                                 <label>     <input type="text" readonly id="ig"  name="tranfers" value="0" div style="border:none;background-color:transparent;font-size:30px;" />    </label>
                    ...
                    <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse4">
                                        Tranfers                   
                                        <input type="text" readonly id="txtValor2"  name="tranfers" value="0" div style="border:none;background-color:transparent;" />                                       
                                     </a>
                                </h4>
                            </div>
                        ...
                        <?php $ttt=0; ?>   
                                            ...
                                            @foreach ($referencia2 as $rf2)
                                                    ...
                                                    <input type="checkbox" id="chk{{ $ttt+=1 }}" name='opcion1' value="{{ $rf2->tr_cost }}" onclick="calculo(this.checked, this.value);" />
                                                    {{ $rf2->tr_name }}
                                                    - 
                                                    <b> Costo: </b>$ {{ $rf2->tr_cost }} 
                                                   <label><input type="text"  id="c{{ $t+=1 }}"  name="tranfers" value="0" class="form-control" div style=width:50px; onkeyup="calculo()" />  </label>
                                                    El resultado es 
                                                    <input type="text"  readonly   id="ct{{ $tt+=1 }}"   name="tranfers" value="0" div style="border:none;background-color:transparent;" /> 
                                                    </label>
                                                    <br>
                                            @endforeach
                                     </div>
                                     <div class="col-sm-4">
                                            <div class="well">
                                                <span>C/U</span>
                                                <label>    
                                                    <input type="text" readonly id="it"  name="tranfers" value="0" div style="border:none;background-color:transparent;font-size:30px;" /> 
                                                </label>
                                            </div>
                                     </div>
                                </div>
                     ...
                     <div class="panel panel-default">
                                      <div class="panel-heading">
                                        <h4 class="panel-title">
                                            ...
                                            Pasaje aereo</a>
                                            <input type="text" readonly  id="subtotal7" name="ticket" value="0"  div style="border:none;background-color:transparent;"/>                           
                                        </h4>
                                      </div>
                    ...
                    <div class="panel panel-default">
                                      <div class="panel-heading">
                                        <h4 class="panel-title">
                                            ...
                                            Calculo por persona</a>
                                             <input type="text" name="sub2" id="subtotal" value="0"  disabled="true" div style="border:none;background-color:transparent;"/>                       
                                        </h4>
                                      </div>
                            <div id="collapse6" class="panel-collapse collapse">
                                    ...
                                    <div align="right">
                                            ...
                                            <div class="well" div style=width:20%;margin-right;:2%;>
                                                ...
                                                <input type="text" readonly  name="totalpor" id="cantidad" value="0"   div style="border:none;background-color:transparent;"/>         
                                                <label style="float:lefT;"> Total </label>
                                                <input type="text" readonly  name="totalpor" id="sub8" value="0"   div style="border:none;background-color:transparent;"/>
                                            </div>

                                    </div>  
                                    <div align="right">
                                            <div style=width:25%;>
                                                {!! Form::label('Agregar descuento') !!}
                                                {!! Form::text('',0, ['class'=>'form-control', 'placeholder'=>'Descuento..','id'=>'des','onkeyup'=>'descuento()']) !!}
                                            </div>                                      
                                            <div class="well" div style=width:20%;margin-right:2%;>
                                                <label style="float:lefT;">  Cantidad </label>
                                                <input type="text" readonly id="cantidad2"  name="totalpor"  value="0"   div style="border:none;background-color:transparent;"/>                                          
                                                <label style="float:lefT;">  Descuento </label>
                                                <input type="text" readonly id="descuen"  name="totalpor"  value="0"   div style="border:none;background-color:transparent;"/>
                                            </div>
