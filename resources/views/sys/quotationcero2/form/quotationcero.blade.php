                        ...
                        <div class="well">
                            ...
                            @foreach ($hotels2 as $ho2 )
                                @if($s->ho_name==$ho2->ho_name)
                                    ...
                                    {{ Form::text('first_name', 0, array('font-size' => '3')) }}
                                    <br>
                ...
                @foreach ($referencia as $rf)
                    <div class="checkbox">
                        <label>
                            ...
                            <input type="radio" id="chk_1" name='opcion' value="{{ $rf->cost*0.12 }}"  onclick="calcu(this.checked, this.value);" />
                            <label>calculo de iva</label><br>
                        </label>
                    </div>
                @endforeach
            </div>
