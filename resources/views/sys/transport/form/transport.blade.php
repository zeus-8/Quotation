...
<div class="form-group has-feedback">
    ...
    {!! Form::text('tipo_servicio', null, ['class'=>'form-control', 'placeholder'=>'Tipo de Servicio']) !!}
    <span class="glyphicon glyphicon-usd form-control-feedback"></span>
</div>
<div class="form-group has-feedback">
    {!! Form::label('Capacidad Maxima') !!}
    {!! Form::text('cap_max', null, ['class'=>'form-control', 'placeholder'=>'Capacidad Maxima']) !!}
    <span class="glyphicon glyphicon-usd form-control-feedback"></span>
</div>
<div class="form-group has-feedback">
